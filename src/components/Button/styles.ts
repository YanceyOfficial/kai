export const outlinedStyles = {
  ...
  white: 'border-2 border-b-0 border-[#e5e5e5]'
}
...
export const wrapperStyles = {
  ...
  white: 'bg-[#ffffff] shadow-duolingoWhite'
}

export const wrapperDisabledStyles = 'bg-[#e5e5e5] shadow-duolingoDisabled'
export const wrapperSelectedStyles =
  'bg-[#ddf4ff] border-[#84d8ff] shadow-duolingoSelected'
